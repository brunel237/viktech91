...
SECRET_KEY = os.getenv('DJANGO_SECRET_KEY', 'django-insecure-_nbuq!c6$jhn%o7fs5bs4p7=+)b%&^+n1=d!d6g89m*6ghaa*0')
...
CORS_ALLOWED_ORIGINS = [
    'http://127.0.0.1:5500',  # Replace with your frontend's domain
]
